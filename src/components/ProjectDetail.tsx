...
import { ChevronLeft, Github, Globe, Code, Cpu } from "lucide-react";
...
export function ProjectDetail({
  ...
  // Scroll to top whenever this detail view is shown or project changes
  useEffect(() => {
        ...
        <div className="p-8">
          <div className="flex flex-wrap gap-2 mb-6">
            {project.tags.map((tag, index) => (
              <span
                key={`${project.id}-detail-tag-${index}`}
          ...
          {[...Array(3)].map((_, i) => (
            ...
            >
              ...
              <p className="text-gray-400">
                {i === 0
                  ? "Built with a focus on maintainability and separation of concerns."
                  : i === 1
                  ? "Optimized for speed and efficiency across various workloads."
